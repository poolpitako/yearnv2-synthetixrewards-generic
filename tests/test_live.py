...
# def test_migrate_live(accounts, Strategy, token, live_vault, live_strat, chain, strategist, whale, yfibank, bank, router, pid):
...
#     tx = strategy.cloneStrategy(vault, yfibank, bank, router, pid, {"from": gov})
...
# def test_rescue_snapshot(accounts, yfi, weth, RescueStrategy, Strategy, live_vault, live_strat_weth, live_vault_weth, live_strat, chain, strategist, whale,yfibank, bank, router, pid):
#     gov = accounts.at(live_vault.governance(), force=True)
#     strategist = gov
